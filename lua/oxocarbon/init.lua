...
vim.api.nvim_set_hl(0, "BlinkCmpGhostText", {fg = oxocarbon.base03, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpDoc", {fg = oxocarbon.base05, bg = oxocarbon.base01})
vim.api.nvim_set_hl(0, "BlinkCmpDocBorder", {fg = oxocarbon.base03, bg = oxocarbon.base01})
vim.api.nvim_set_hl(0, "BlinkCmpDocSeparator", {fg = oxocarbon.base02, bg = oxocarbon.base01})
vim.api.nvim_set_hl(0, "BlinkCmpDocCursorLine", {fg = oxocarbon.none, bg = oxocarbon.base02})
vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelp", {fg = oxocarbon.base05, bg = oxocarbon.base01})
vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelpBorder", {fg = oxocarbon.base03, bg = oxocarbon.base01})
vim.api.nvim_set_hl(0, "BlinkCmpSignatureHelpActiveParameter", {fg = oxocarbon.base08, bg = oxocarbon.base02, bold = true})
vim.api.nvim_set_hl(0, "BlinkCmpKind", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "BlinkCmpKindInterface", {fg = oxocarbon.base01, bg = oxocarbon.base08})
vim.api.nvim_set_hl(0, "BlinkCmpKindColor", {fg = oxocarbon.base01, bg = oxocarbon.base08})
vim.api.nvim_set_hl(0, "BlinkCmpKindTypeParameter", {fg = oxocarbon.base01, bg = oxocarbon.base08})
...
vim.api.nvim_set_hl(0, "BlinkCmpKindProperty", {fg = oxocarbon.base01, bg = oxocarbon.base12})
...
vim.api.nvim_set_hl(0, "NavicSeparator", {fg = oxocarbon.base03, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NavicIconsNamespace", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsPackage", {fg = oxocarbon.base11, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NavicIconsStruct", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsMethod", {fg = oxocarbon.base15, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NavicIconsEnumMember", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsConstant", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsString", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsNumber", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsBoolean", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsNull", {fg = oxocarbon.base15, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsKey", {fg = oxocarbon.base09, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsArray", {fg = oxocarbon.base11, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NavicIconsObject", {fg = oxocarbon.base11, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "NavicIconsTypeParameter", {fg = oxocarbon.base08, bg = oxocarbon.none})
